...
public abstract class Guest {
    ...
    /**
     * The monster would like to visit the cell occupied by this guest.
     * Indicate whether this is possible, and modify the move's state to
     * indicate what the effect of such a move would be.
     * Precondition: the move object is non null and initializing.
     * <p>
     *
     * @param aMove
     *            the Move move object representing intended move and its
     *            effects.
     *
